        ...
        <div class="box box-primary container">
            ...
            <form role="form" class="forms-sample" method="post" action="{{route('HomePage.update',$sliders->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="author" class="col-sm-4 col-form-label">Subtitle</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control p-input" id="price" name="price" value="{{$sliders->price}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="author" class="col-sm-4 col-form-label">Subtitle</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control p-input" id="newprice" name="newprice" value="{{$sliders->newprice}}">
                    </div>
                </div>
