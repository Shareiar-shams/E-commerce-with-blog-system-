    ...
    <div class="col-lg-6">
		<!-- Horizontal Form -->
     	<div class="box box-info">
        	...
        	<!-- /.box-header -->
        	<!-- form start -->
        	<form class="form-horizontal" method="post" action="{{route('post-category.update',$categories->id)}}">
        		{{csrf_field()}}
        		{{method_field('PUT')}}
          		<div class="box-body">
	                <div class="form-group">
	                  	...
	                  	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="inputEmail3" name="name" value="{{$categories->name}}" required="required">
	                  	</div>
	                </div>
	                <div class="form-group">
          		...
          		<div class="box-footer">	                		
            		...
            		<a href="{{route('post-category.index')}}" type="submit" class="btn btn-danger pull-right">Go Back</a>
          		</div>
          		<!-- /.box-footer -->
        	</form>
      	</div>
